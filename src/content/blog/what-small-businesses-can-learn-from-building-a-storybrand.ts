...
const post: BlogPost = {
  slug: 'what-small-businesses-can-learn-from-building-a-storybrand',
  number: '12',
  title: 'What Small Businesses Can Learn from Building a StoryBrand',
  shortTitle: 'StoryBrand Lessons',
  excerpt:
  ...
  readTime: '7 min read',
  featured: true,
  image: '/blog/blog-12-storybrand-podcast.png',
  keywords: [
    ...
    'website strategy',
    'webloft studio podcast',
    'storybrand framework',
    'clear messaging',
  ],
  takeaways: [
    'Your customer should be the hero of your marketing, not your business.',
    'Clear messaging is more powerful than clever or complicated messaging.',
    'A strong website should quickly explain what you offer, how it helps, and what action visitors should take.',
  ],

  /* Podcast fields */
  audioUrl: '/api/audio?file=podcast/building-a-story-brand.mp3&v=2026-05-13-mp3',
  ...
  sections: [
    {
      id: 'intro',
      heading: 'Your Website Might Look Great \u2014 But Is It Working?',
      paragraphs: [
        ...
        'That is one of the biggest lessons from <em>Building a StoryBrand</em> by Donald Miller: when you confuse, you lose.',
    ...
    {
      id: 'why-clear-messaging-matters',
      heading: 'Why Clear Messaging Matters for Small Businesses',
      paragraphs: [
    ...
    {
      id: 'customer-is-the-hero',
      heading: 'Your Customer Is the Hero, Not Your Business',
      paragraphs: [
        'One of the most important ideas from <em>Building a StoryBrand</em> is that your customer should be the hero of the story. Your business is not the hero. Your business is the guide.',
    ...
    {
      id: 'grunt-test',
      heading: 'The Grunt Test: Can People Understand Your Website in Seconds?',
      paragraphs: [
        'One of the most practical ideas from <em>Building a StoryBrand</em> is the "grunt test." The idea is simple: if someone looked at your website for only a few seconds, could they quickly understand what you offer, how it helps them, and what they should do next?',
    ...
    {
      id: 'customers-buy-solutions',
      heading: 'Customers Buy Solutions to Problems',
      paragraphs: [
        'Another important lesson from <em>Building a StoryBrand</em> is that customers are usually dealing with more than one type of problem. There is the external problem, which is the obvious issue. But there is also the internal problem, which is how that issue makes the customer feel.',
    ...
    {
      id: 'position-as-guide',
      heading: 'Your Website Should Position You as the Guide',
      paragraphs: [
    ...
    {
      id: 'simple-plan',
      heading: 'Give Visitors a Simple Plan',
      paragraphs: [
      ...
      bullets: [
        '<strong>Service business example:</strong> 1. Book a free call. 2. Get a custom website strategy. 3. Launch a website that helps your business grow.',
        '<strong>Roofing company example:</strong> 1. Request a free estimate. 2. Schedule an inspection. 3. Get your roof repaired with confidence.',
        '<strong>Restaurant example:</strong> 1. Share your menu and brand details. 2. Approve the website design. 3. Launch your site and make it easier for customers to find you.',
      ],
    },
    {
      id: 'call-to-action',
      heading: 'Your Call to Action Should Be Obvious',
      paragraphs: [
    ...
    },
    {
      ...
      heading: 'Show the Cost of Doing Nothing',
      paragraphs: [
    ...
    {
      id: 'picture-of-success',
      heading: 'Paint a Clear Picture of Success',
      paragraphs: [
    ...
    },
    {
      ...
      intro: 'If you apply the lessons from Building a StoryBrand to your website, your homepage should become much clearer.',
      paragraphs: [
    ...
    {
      id: 'seo-and-messaging',
      heading: 'SEO Gets People to Your Website. Messaging Converts Them.',
      paragraphs: [
    ...
    {
      id: 'common-mistakes',
      heading: 'Common Website Messaging Mistakes Small Businesses Make',
      paragraphs: [
    ...
    },
    {
      ...
      intro: 'If you want to improve your website messaging, start by reviewing your homepage.',
      paragraphs: [
    ...
    {
      id: 'final-thoughts',
      heading: 'The Clearest Business Usually Wins',
      paragraphs: [
        'The biggest lesson small businesses can take from <em>Building a StoryBrand</em> is simple: your website should make your customer\u2019s life easier, not more confusing.',
  ...
  ctaTitle: 'Need Help Improving Your Website Messaging?',
  ctaText:
  ...
  related: [
    'best-marketing-books-small-business-get-clients',
