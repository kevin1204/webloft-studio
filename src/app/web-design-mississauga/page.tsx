...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Web Design Services in Mississauga | Custom Website Design | Webloft Studio",
    description: "Professional web design services in Mississauga. Custom websites, responsive design, SEO optimization. Local web design company serving Mississauga and surrounding areas.",
    url: "https://webloftstudio.com/web-design-mississauga",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Web Design Services in Mississauga - Webloft Studio",
      },
    ],
    locale: "en_CA",
    type: "website",
...
export default function WebDesignMississauga() {
  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Webloft Studio",
            "description": "Professional web design services in Mississauga. Custom websites, responsive design, SEO optimization.",
            "url": "https://webloftstudio.com/web-design-mississauga",
            "telephone": "+1-226-376-6326",
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "123 Square One Drive",
          ...
          <div className="relative z-10 mx-auto flex flex-1 w-full max-w-4xl flex-col items-center px-4 text-center gap-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center gap-4 sm:gap-6">
              <h1 className="text-[32px] sm:text-5xl md:text-6xl font-bold text-white leading-tight animate-fade-in-up">
                ...
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-600">Mississauga, Ontario</span>
              </h1>

              <p className="text-base sm:text-2xl text-gray-200 max-w-3xl mx-auto leading-relaxed animate-fade-in-up stagger-1">
                We build high-performing websites for businesses in Mississauga and surrounding areas. Your local web design company delivering results that drive growth.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up stagger-2">
                <Link href="/contact" className="btn-primary-enhanced text-lg px-8 py-4 animate-bounce-attention">
                  Start Your Mississauga Project
                </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              We don't just build websites—we build success stories. Here's the impact we've made for our Mississauga clients.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div className="p-6 hover-glow rounded-xl transition-all duration-300 hover:scale-105 animate-fade-in-up stagger-1">
              ...
              <div className="text-sm text-gray-500 dark:text-gray-400 mt-1">Across Mississauga and area</div>
            </div>
      ...
      {/* Why Choose Local Web Design in Mississauga Section */}
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-12 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-4 py-2 bg-green-100 dark:bg-green-900/30 rounded-full text-green-700 dark:text-green-300 text-sm font-medium mb-6 animate-fade-in-up">
              ...
              Serving Mississauga & Peel Region
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6 animate-fade-in-up stagger-1">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-emerald-600"> Mississauga, Ontario</span>?
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed animate-fade-in-up stagger-2">
              As your local web design company in Mississauga, we understand the unique needs of businesses in Peel Region. We're not just another agency—we're your neighbors, committed to your success.
            </p>
          </div>
            ...
            <div className="group relative flex flex-col">
              ...
              <div className="relative bg-white dark:bg-gray-800 p-6 md:p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 animate-fade-in-up stagger-1 flex flex-col h-full">
                ...
                <div className="mb-6 pr-20 flex flex-col flex-grow">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 group-hover:text-green-600 transition-colors duration-300 pr-4">Mississauga Market Knowledge</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed flex-grow">
                    We understand Mississauga's diverse business landscape, from Square One to Port Credit. Our web design strategies are tailored to local market trends and customer behavior.
                  </p>
                </div>
                <div className="space-y-3 mt-auto">
                  <div className="flex items-center hover:scale-105 transition-transform duration-300">
                    ...
                    <span className="text-gray-700 dark:text-gray-300 font-medium">Mississauga-specific SEO strategies</span>
                  </div>
                  <div className="flex items-center hover:scale-105 transition-transform duration-300">
                    <div className="w-6 h-6 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center mr-3 hover:scale-110 transition-transform duration-300">
                      <svg className="w-3 h-3 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-gray-700 dark:text-gray-300 font-medium">Peel Region business insights</span>
                  </div>
                  <div className="flex items-center hover:scale-105 transition-transform duration-300">
                    <div className="w-6 h-6 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center mr-3 hover:scale-110 transition-transform duration-300">
                      <svg className="w-3 h-3 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="group relative flex flex-col">
              ...
              <div className="relative bg-white dark:bg-gray-800 p-6 md:p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 animate-fade-in-up stagger-2 flex flex-col h-full">
                ...
                <div className="mb-6 pr-20 flex flex-col flex-grow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed flex-grow">
                    Being local means we can meet in person to discuss your project, understand your vision, and build stronger relationships with our Mississauga clients.
                  </p>
                </div>
                <div className="space-y-3 mt-auto">
                  <div className="flex items-center hover:scale-105 transition-transform duration-300">
            ...
            <div className="group relative flex flex-col">
              ...
              <div className="relative bg-white dark:bg-gray-800 p-6 md:p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 animate-fade-in-up stagger-3 flex flex-col h-full">
                ...
                <div className="mb-6 pr-20 flex flex-col flex-grow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed flex-grow">
                    We're invested in Mississauga's success. When you choose us, you're supporting a local business that cares about the community's growth and prosperity.
                  </p>
                </div>
                <div className="space-y-3 mt-auto">
                  <div className="flex items-center hover:scale-105 transition-transform duration-300">
      ...
      <section className="py-20 bg-gradient-to-r from-green-400 to-emerald-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Ready to Transform Your Mississauga Business Online?
          </h2>
          ...
          >
            Get Your Free Mississauga Consultation
          </Link>
        </div>
      </section>
    </>
